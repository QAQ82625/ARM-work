...
- FUNC键立即停止
- LED1：使能=常亮 / 响铃=快闪
- `*SET:ALARM HOUR/MIN/SEC/OFF` 远程设定
- EXT键 切换闹钟使能/禁用
...
|----|------|------|
| LED0 | 系统心跳 | 500ms翻转 |
| LED1 | 闹钟 | 使能=常亮 / 响铃=快闪(200ms) |
| LED2 | 编辑模式 | 编辑中常亮 |
| LED3 | TX/RX | 收发后亮300ms |
| LED4 | 晴天 ☀️ | 天气SUN时常亮 |
| LED5 | 雨雪 🌧️ | 天气RAI/SNO时常亮 |
| LED6 | 高温 🔥 | ≥30°C时常亮 |
| LED7 | NTP同步 | SYNCED=常亮 / DRIFT(>24h)=闪烁 |
...
| ⏰ 闹钟管理 | *SET:ALARM 直设，启用/禁用切换，从MCU读取 |
...
| 待完成 | §4.3 多闹钟调度器（自定义功能 8分） | 🔲 |
| 待完成 | P4 打磨（编辑高亮镜像、夜间4位限定） | 🔲 |
