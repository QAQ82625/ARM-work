...
| 位 | 名称 | 含义 | 行为 |
|----|------|------|------|
| LED0 (bit0) | ❤️ 系统心跳 | 系统运行指示 | **1Hz 闪烁** (500ms亮/500ms灭) |
| LED1 (bit1) | ⏰ 闹钟状态 | 闹钟使能+响铃 | **使能=常亮** / **响铃=200ms快闪** |
| LED2 (bit2) | ✏️ 编辑模式 | 编辑状态指示 | 编辑中=常亮 |
| LED3 (bit3) | 📤📥 TX/RX | UART收发活动 | 有收发时**亮300ms**后灭 |
| LED4 (bit4) | ☀️ 晴天指示 | 天气=SUN | 晴天时**常亮** |
| LED5 (bit5) | 🌧️ 雨雪指示 | 天气=RAI/SNO | 雨雪时**常亮** |
| LED6 (bit6) | 🔥 高温指示 | 温度≥30°C | 高温时**常亮** |
| LED7 (bit7) | 🕐 NTP同步 | NTP对时状态 | **未同步=灭** / **已同步=常亮** / **>24h未更新=1Hz闪** |
